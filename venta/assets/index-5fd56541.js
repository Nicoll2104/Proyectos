...
function Mn(e = !1, t = !1) {
  return function (s, r, o) {
    ...
    if (r === "__v_raw" && o === (e ? (t ? so : Ks) : t ? Us : $s).get(s))
      return s;
    const i = P(s);
    if (!e) {
...
function Hs(e = !1) {
  return function (n, s, r, o) {
    ...
    if (
      !e &&
      (!Nt(r) && !Ve(r) && ((i = L(i)), (r = L(r))), !P(n) && V(i) && !V(r))
    )
      return (i.value = r), !0;
    const c = P(n) && On(s) ? Number(s) < n.length : H(n, s),
      f = Reflect.set(n, s, r, o);
    return (
      n === L(o) && (c ? dt(r, i) && ve(n, "set", s, r) : ve(n, "add", s, r)), f
    );
  };
}
function Jr(e, t) {
...
const Ls = { get: Lr, set: Dr, deleteProperty: Jr, has: zr, ownKeys: qr },
  kr = {
    get: Ur,
    set(e, t) {
      return !0;
...
function Ot(e, t = !1) {
  return (
    (e = e.__v_raw), !t && ne(L(e), "iterate", Ke), Reflect.get(e, "size", e)
  );
}
function Gn(e) {
  e = L(e);
...
function jn(e) {
  return Ve(e) ? e : Nn(e, !1, Ls, eo, $s);
}
function io(e) {
  return Nn(e, !1, Yr, to, Us);
}
function Bs(e) {
  return Nn(e, !0, kr, no, Ks);
}
...
const ht = (e) => (W(e) ? jn(e) : e),
  Sn = (e) => (W(e) ? Bs(e) : e);
function Js(e) {
  Pe && le && ((e = L(e)), Ns(e.dep || (e.dep = Pn())));
}
function zs(e, t) {
  e = L(e);
  const n = e.dep;
...
function bo(e) {
  P(e)
    ? Ze.push(...e)
    : (!xe || !xe.includes(e, e.allowRecurse ? $e + 1 : $e)) && Ze.push(e),
    Ys();
}
...
function Xs(e) {
  if (Ze.length) {
    ...
    for (xe = t, xe.sort((n, s) => gt(n) - gt(s)), $e = 0; $e < xe.length; $e++)
      xe[$e]();
    (xe = null), ($e = 0);
  }
}
...
function tn(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      const j = r || s;
      (S = pe(_.call(j, j, y, o, A, E, F))), (D = f);
    } else {
      const j = t;
      (S = pe(
        j.length > 1 ? j(o, { attrs: f, slots: c, emit: a }) : j(o, null)
      )),
        (D = t.props ? f : Co(f));
    }
  } catch (j) {
    (at.length = 0), Dt(j, e, 1), (S = ye(De));
  }
  let X = S;
  if (D && M !== !1) {
    const j = Object.keys(D),
      { shapeFlag: Ee } = X;
    j.length && Ee & 7 && (i && j.some(wn) && (D = Oo(D, i)), (X = Ge(X, D)));
  }
  return (
...
function Vs(
  ...
  if (
    (V(e)
      ...
      : P(e)
      ? ((y = !0),
        (_ = e.some((j) => Xe(j) || Nt(j))),
        (a = () =>
          e.map((j) => {
            if (V(j)) return j.value;
            if (Xe(j)) return qe(j);
            if (R(j)) return Ae(j, f, 2);
          })))
      : R(e)
      ? t
        ? (a = () => Ae(e, f, 2))
  ...
  const S = () => {
    if (J.active)
      if (t) {
        const j = J.run();
        (s || _ || (y ? j.some((Ee, rt) => dt(Ee, M[rt])) : dt(j, M))) &&
          (E && E(),
          fe(t, f, 3, [j, M === Pt ? void 0 : y && M[0] === Pt ? [] : M, A]),
          (M = j));
      } else J.run();
  };
  S.allowRecurse = !!t;
...
function zo(e) {
  ...
  if (((_n = !0), o))
    for (const z in o) {
      const U = o[z],
        Ne = R(U) ? U.bind(n, n) : R(U.get) ? U.get.bind(n, n) : ue,
  ...
  _ && is(_, e, "c");
  function G(z, U) {
    P(U) ? U.forEach((Ne) => z(Ne.bind(n))) : U && z(U.bind(n));
  }
  if (
    (G(No, y),
    G(So, E),
...
const lr = (e) => e[0] === "_" || e === "$stable",
  ...
  ni = (e, t) => {
    if (e.vnode.shapeFlag & 32) {
      const n = t._;
      n ? ((e.slots = L(t)), jt(t, "_", n)) : cr(t, (e.slots = {}));
...
function oi(e, t) {
  ...
  const {
    ...
    rt = (l, u, d, p, h, b, v, m) => {
      let x, g;
      const { type: C, props: w, shapeFlag: O, transition: T, dirs: N } = l;
      if (
        ...
        for (const $ in w)
          $ !== "value" &&
            !At($) &&
            o(x, $, null, w[$], b, l.children, p, h, me);
        "value" in w && o(x, "value", null, w.value),
          (g = w.onVnodeBeforeMount) && he(g, p, l);
      }
      N && He(l, null, p, "beforeMount");
      const K = (!h || (h && !h.pendingBranch)) && T && !T.persisted;
      K && T.beforeEnter(x),
        s(x, u, d),
        ((g = w && w.onVnodeMounted) || K || N) &&
          te(() => {
            g && he(g, p, l), K && T.enter(x), N && He(l, null, p, "mounted");
          }, h);
    },
    bt = (l, u, d, p, h) => {
    ...
    Yt = (l, u, d, p, h, b, v) => {
      ...
      if (
        (g
          ? je(l.dynamicChildren, g, m, d, p, N, b)
          : v || U(l, u, m, null, d, p, N, b, !1),
        x > 0)
      ) {
    ...
    xt = (l, u, d, p, h, b, v, m, x) => {
      ...
      T && (m = m ? m.concat(T) : T),
        l == null
          ...
          ? (je(l.dynamicChildren, O, d, h, b, v, m),
    ...
    G = (l, u, d, p, h, b, v) => {
      const m = () => {
          if (l.isMounted) {
            let { next: C, bu: w, u: O, parent: T, vnode: N } = l,
              K = C,
              $;
            Le(l, !1),
              C ? ((C.el = N.el), z(l, C, v)) : (C = N),
              w && Gt(w),
              ($ = C.props && C.props.onVnodeBeforeUpdate) && he($, T, C, N),
              Le(l, !0);
            const q = tn(l),
              oe = l.subTree;
            (l.subTree = q),
              ...
              K === null && Io(l, q.el),
              O && te(O, h),
              ($ = C.props && C.props.onVnodeUpdated) &&
                te(() => he($, T, C, N), h);
          } else {
            let C;
            ...
            if (
              (Le(l, !1),
              T && Gt(T),
              !$ && (C = O && O.onVnodeBeforeMount) && he(C, K, u),
              Le(l, !0),
              w && Qt)
            ) {
              const q = () => {
            ...
            if ((N && te(N, h), !$ && (C = O && O.onVnodeMounted))) {
              const q = u;
              te(() => he(C, K, q), h);
            }
            (u.shapeFlag & 256 ||
        ...
        x = (l.effect = new An(m, () => Ln(g), l.scope)),
        g = (l.update = () => x.run());
      (g.id = l.uid), Le(l, !0), g();
    },
    z = (l, u, d) => {
    ...
    vt = (l, u, d, p, h, b, v, m, x) => {
      ...
      for (; g <= w && g <= O; ) {
        const T = l[g],
          N = (u[g] = x ? Ie(u[g]) : pe(u[g]));
        if (lt(T, N)) M(T, N, d, null, h, b, v, m, x);
        else break;
        g++;
      }
      for (; g <= w && g <= O; ) {
        const T = l[w],
          N = (u[O] = x ? Ie(u[O]) : pe(u[O]));
        if (lt(T, N)) M(T, N, d, null, h, b, v, m, x);
        else break;
        w--, O--;
      }
      if (g > w) {
        if (g <= O) {
          const T = O + 1,
            N = T < C ? u[T].el : p;
          for (; g <= O; )
            M(null, (u[g] = x ? Ie(u[g]) : pe(u[g])), d, N, h, b, v, m, x), g++;
        }
        ...
        for ($ = kn.length - 1, g = oe - 1; g >= 0; g--) {
          const se = N + g,
            de = u[se],
            Yn = se + 1 < C ? u[se + 1].el : p;
          it[g] === 0
            ? M(null, de, d, Yn, h, b, v, m, x)
            : Je && ($ < 0 || g !== kn[$] ? Se(de, d, Yn, 2) : $--);
        }
      }
    },
    Se = (l, u, d, p, h = null) => {
    ...
    ae = (l, u, d, p = !1, h = !1) => {
      ...
      const T = C & 1 && O,
        N = !Mt(l);
      let K;
      if ((N && (K = v && v.onVnodeBeforeUnmount) && he(K, u, l), C & 6))
        mr(l.component, d, p);
      else {
        if (C & 128) {
...
const Yi = "./tienda_mangas/assets/carrito-34e00f0d.png",
  Xi = "./tienda_mangas/assets/one_piece-f12c142f.webp",
  Zi = "./tienda_mangas/assets/seven-3afbace6.webp",
  Qi = "./tienda_mangas/assets/banana-288bd019.jpg",
  Vi = "./tienda_mangas/assets/hero-4efcdd7a.webp",
  Gi = "./tienda_mangas/assets/koro-bd35c621.webp",
  el = "./tienda_mangas/assets/kaisen-cde17fca.webp",
  tl = "./tienda_mangas/assets/horimiya-e4a56f07.png",
  nl = "./tienda_mangas/assets/yuri-e8736898.jpg",
  sl = "./tienda_mangas/assets/ghoul-6c206b1f.webp",
  rl = "./tienda_mangas/assets/koe-eb581835.jpg",
  ol = "./tienda_mangas/assets/bungou-b5d12602.webp";
const il = (e, t) => {
    const n = e.__vccOpts || e;
    for (const [s, r] of t) n[s] = r;
    return n;
  },
  Fe = (e) => (vo("data-v-cc25d084"), (e = e()), wo(), e),
  ll = { class: "body" },
  cl = Fe(() =>
    I(
      "div",
  ...
  al = Fe(() => I("img", { class: "carri", src: Yi, alt: "" }, null, -1)),
  dl = [al],
  ...
  bl = ["onClick"],
  xl = ["onClick"],
  yl = Fe(() => I("td", null, null, -1)),
  vl = Fe(() => I("td", null, null, -1)),
  wl = Fe(() => I("td", { class: "total" }, "Total:", -1)),
  El = { class: "total" },
  Cl = Fe(() =>
    I(
      "div",
      ...
      return (F, M) => (
        ...
        Te("div", ll, [
          ...
          I("div", ul, [
            fl,
            I("div", { class: "boton" }, [
              I("button", { onClick: i, class: "boton1" }, dl),
            ]),
            I("div", hl, [
              t.value
                ? (be(),
                          ...
                          (S, D) => (
                            ...
                            Te("tr", { key: D }, [
                              ...
                              I("td", null, [
                                ...
                                I(
                                  "button",
                                  { class: "boton3", onClick: (J) => y(D) },
                                  "+",
                                  8,
                                  bl
                                ),
                              ]),
                              I("td", null, Ce(_(S.precio) * S.cantidad), 1),
                              I("td", null, [
                                I(
                                  "button",
  ...
  Ml = il(Al, [["__scopeId", "data-v-cc25d084"]]);
qi(Ml).mount("#app");
